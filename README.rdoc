...
== How to use
[example](https://github.com/medpeer-dev/open-clinic-rails/pull/991/commits/3d0c4f3902bf1b71ebf01e1633096aac674608f6)

1. Add Rails Footnotes to Gemfile
    gem 'rails-footnotes', git: 'https://github.com/mpg-kaoru-hotate/rails-footnotes.git'
